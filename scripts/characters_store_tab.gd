...
@onready var panel_container: MarginContainer = $HBoxContainer/ScrollContainer/GridContainer/PanelContainer
...
func _ready() -> void:
	for character in Database.characters:
		...
		new_node.set_script(load("res://scripts/store_panel.gd"))
